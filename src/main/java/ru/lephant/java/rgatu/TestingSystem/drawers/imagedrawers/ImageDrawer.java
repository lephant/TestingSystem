...
import ru.lephant.java.rgatu.TestingSystem.entities.Image;
...
public class ImageDrawer {
    ...
    public void drawImage(Image image, VBox choiceBox, int position) {
        InputStream stream = new ByteArrayInputStream(image.getContent());
